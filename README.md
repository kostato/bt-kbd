...
Both risks are acceptable for personal, single-user use on a trusted network. See [`SECURITY_REVIEW.md`](docs/SECURITY_REVIEW.md) for full findings and proposed mitigations.
